...
export default async function Home({
  ...
  return (
    <>
      ...
      <main>
        {/* ── HERO ──────────────────────────────────────────────────────────── */}
        <section style={{ background: "#f6f6f4", padding: "100px 24px 80px", borderBottom: "1px solid #e8e8e8", overflow: "hidden" }}>
          <div style={{
            maxWidth: 1100,
            margin: "0 auto",
            display: "flex",
        ...
        {/* ── SECOND BRAIN ──────────────────────────────────────────────── */}
        <section style={{ background: "#f6f6f4", padding: "0 24px 80px" }}>
          <div style={{ maxWidth: 1000, margin: "0 auto" }}>
