...
export default function TemplatesPage() {
  ...
  return (
    <>
      {/* Header */}
      <section style={{ background: "#ffffff", padding: "64px 24px 48px", borderBottom: "1px solid #e6e6e6" }}>
      ...
      {/* Filters */}
      <div style={{ background: "#ffffff", borderBottom: "1px solid #e6e6e6", position: "sticky", top: 60, zIndex: 50 }}>
