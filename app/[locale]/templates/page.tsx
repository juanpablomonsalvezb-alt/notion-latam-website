...
export default function TemplatesPage() {
  ...
  return (
    <>
      {/* Header */}
      <section style={{ background: "#f6f6f4", padding: "64px 24px 48px", borderBottom: "1px solid #e6e6e6" }}>
      ...
      {/* Filters */}
      <div style={{ background: "#f6f6f4", borderBottom: "1px solid #e6e6e6", position: "sticky", top: 60, zIndex: 50 }}>
      ...
      {/* Grid */}
      <section style={{ background: "#f6f6f4", padding: "48px 24px 80px" }}>
